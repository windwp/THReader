...
namespace TungHoanhReader.Wrapper
{
    public class TruyenConvertWrapper : IWraper
    {
        ...
        public static string HOME_PAGE_TOP = "http://truyencv.com/danh-sach/moi-cap-nhat/trang-{0}/";
        public static string HOME_PAGE_THE_LOAI_TOP = "http://truyencv.com/{0}/trang-{1}/";
        public static string TIM_KIEM_THE_URL = "http://truyencv.com/tim-kiem/all/{0}/trang-{1}/";
        ...
        public async Task<ChapterLoadData> GetPageChapTer(Truyen truyen, int page, bool allowGetNoidung = true)
        {
            ...
            if (htmlData.Status)
            {
                ...
                if (cDom != null) truyen.Description = FixHtmlString(WebUtility.HtmlDecode(cDom.InnerHtml.Trim()));
        ...
        public string FixHtmlString(string inpPutString)
        {
            ...
            var temp = reg.Replace(inpPutString.ToString(), "\r\n");
            reg = new Regex(@"<.*\s*/?>");
